...
public class WiimoteManager
{
    ...
    public static List<global::Wiimote.Wiimote> Wiimotes { get { return _Wiimotes; } }
    private static List<global::Wiimote.Wiimote> _Wiimotes = new List<global::Wiimote.Wiimote>();
    ...
    private static bool _FindWiimotes(WiimoteType type)
    {
        ...
        {
            global::Wiimote.Wiimote remote = null;
            bool fin = false;
            foreach (global::Wiimote.Wiimote r in Wiimotes)
            {
                if (fin)
                    continue;
            ...
            if (remote == null)
            {
                ...
                remote = new global::Wiimote.Wiimote(handle, enumerate.path, trueType);
    ...
    public static void Cleanup(global::Wiimote.Wiimote remote)
    {
        if (remote != null)
        {
